      ...
      <div class="navbar navbar-inverse navbar-fixed-bottom">
        <div class="container d-flex">
          ...
          <p className="p-2 flex-grow-1 fw-semibold fs-6">
            Yash Garg
            <a href="https://www.linkedin.com/in/yash-garg-6156341a4/" target="_blank" rel="noopener noreferrer">
              <i class="mx-1 p-2 fa-brands fa-linkedin"></i>
            </a>
            <a href="https://github.com/Yash2312garg" target="_blank" rel="noopener noreferrer">
